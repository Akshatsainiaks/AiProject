...
const GenerateImages = () => {
     ...
     const imageStyle = ['Realistic', 'Ghibli style', 'Anime style', 'Cartoon style', 'Fanstasy', 'Realistic style', '3D style', 'Portrait style']
            
            const [selectedStyle,setSeletedStyle] = useState('Realistic')
  ...
  return (
   <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
    ...
    <div className='flex items-center gap-3'>
        ...
        <h1 className='text-xl font-semibold'>All Image Generator</h1>
    </div>
    ...
    <textarea onChange={(e)=>setInput(e.target.value)} value={input} rows={4} className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border
     ...
     {imageStyle.map((item)=>(
        <span onClick={()=>setSeletedStyle(item)} 
